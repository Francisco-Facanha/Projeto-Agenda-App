...
contatos: Contato[] = [];
colunas = ['foto','id', 'nome','sobrenome','email','favorito'];
...
this.listarContatos(this.pagina, this.tamanho);
  ...
  favoritar(contato: Contato){
    ...
    submit(){
     ...
     const contato : Contato = new Contato(formValues.nome, formValues.sobrenome, formValues.email)
  ...
  visializarContato(contato:Contato){
